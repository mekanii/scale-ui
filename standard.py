...
class StandardContent:
    def __init__(self, parent, tasks):
        ...
        self.tasks = tasks  # Initialize the tasks attribute
    ...
    def open_dialog(self, entry=None):
        ...
        tk.Button(
            ...
            borderwidth=0,
            highlightthickness=0
        ).pack(side=tk.LEFT)  # Submit button on the left
        ...
        tk.Button(
            ...
            font=('Segoe UI', 10),
            text="Clear",
            command=lambda: self.clear(part_name_entry, self.part_std_entry, unit_var),
            relief=tk.FLAT,
            fg='black',
            bd=0,
            borderwidth=0,
            highlightthickness=0
        ).pack(side=tk.RIGHT, padx=(5, 0))  # Clear button on the right
        ...
        tk.Button(
            ...
            borderwidth=0,
            highlightthickness=0
        ).pack(side=tk.RIGHT, padx=(5, 0))  # Cancel button on the right
